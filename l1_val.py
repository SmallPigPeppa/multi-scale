...
class MSNetValPL(pl.LightningModule):
    ...
    def validation_epoch_end(self, outputs):
        ...
        self.log(name='acc1', value={"acc": torch.tensor(acc1_list), "x_axis": torch.tensor(self.size_list)}, on_step=False, prog_bar=False)
        self.log(name='acc2', value={"acc": torch.tensor(acc2_list), "x_axis": torch.tensor(self.size_list)}, on_step=False, prog_bar=False)
        self.log(name='acc3', value={"acc": torch.tensor(acc3_list), "x_axis": torch.tensor(self.size_list)}, on_step=False, prog_bar=False)
        self.log(name='acc_best', value={"acc": torch.tensor(acc_best_list), "x_axis": torch.tensor(self.size_list)}, on_step=False, prog_bar=False)
